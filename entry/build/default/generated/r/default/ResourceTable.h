...
const int32_t STRING_DISTRIBUTED_SYNC_REASON = 0x0100000f;
...
const int32_t MEDIA_AIRBUS_LOGO = 0x0100000c;
const int32_t MEDIA_BACKGROUND = 0x01000001;
const int32_t MEDIA_BOEING_LOGO = 0x0100000d;
const int32_t MEDIA_COMAC_LOGO = 0x0100000e;
